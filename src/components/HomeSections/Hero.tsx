...
const Hero:FC = () => {
  ...
  return (
    <div className='w-full h-[250px] md:h-screen flex flex-col justify-center items-center relative overflow-hidden gap-10 animate-fade-in-up mt-16 md:mt-12 lg:mt-0'>
         <style>
        {`
          @keyframes float {
