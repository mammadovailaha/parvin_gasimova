...
const Hero:FC = () => {
  ...
  return (
    <div className='w-full h-[250px] md:h-screen flex flex-col justify-center items-center relative overflow-hidden gap-10 animate-fade-in-up'>
     ...
     <TypingText text="Qrafik & Motion dizayner" className="font-poppins font-semibold text-3xl md:text-5xl text-black z-40 relative bg-gradient-to-r from-black to-gray-400 bg-clip-text text-transparent inline-block" />
    <ServicesSlider onClick={()=>{navigate("/portfolio")}} className="bg-[#f8f8f8]" textStyle="text-lg font-poppins font-light text-black dark:text-white" data={services} />
    </div>
  )
}
