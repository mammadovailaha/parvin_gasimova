...
const SecondryBtn = ({ text, onClick, className }: btnProps) => {
  ...
  <button
      onClick={onClick}
      className={` ${className} relative inline-block bg-transparent border border-gray-200 outline-none rounded-[30px] tracking-normal overflow-hidden group h-12 px-6`}
    >
      {/* Ön tərəf */}
