...
const PortfolioCard: FC<Props> = ({ item }) => {
  ...
  return (
    ...
    >
      ...
      {isHovered && (
        <div
          className="absolute w-[100px] h-[100px] bg-white rounded-full flex items-center justify-center pointer-events-none z-30 transition-opacity duration-200 shadow-lg"
          style={{
